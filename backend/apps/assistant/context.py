...
ADMIN_PAGE_CONTEXTS = {
    ...
    "ops:announcements": {
        "label": "公告中心页",
        "summary": "用于向全站普通用户发布系统公告，并回看最近公告记录。",
        "features": [
            "可发布公告：填写标题、正文和跳转路径后立即写入站内提醒。",
            "公告列表：查看最近公告、发布时间、发布人和触达人数。",
            "更适合处理系统维护、功能变更、重要通知，不适合发零散运营碎片。",
        ],
        "workflow": [
            "先确认这件事是否值得打扰全站用户。",
            "再把标题、正文和跳转路径写清楚，确保用户知道发生了什么、该去哪里继续。",
            "发布后回看最近公告列表，确认触达人数和文案是否符合预期。",
        ],
        "risks": [
            "公告标题过长或正文过模糊，会让提醒变成噪音。",
            "跳转路径必须指向真实可访问页面，否则用户点开后体验会断掉。",
        ],
    },
    "ops:users": {
        "label": "用户管理页",
